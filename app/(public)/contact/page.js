        ...
        <div className={styles.contactPage}>
            ...
            <div className="container">
                <div className={styles.contactGrid}>
                    ...
                    >
                        <h2>{language === 'en' ? 'Get In Touch' : 'సంప్రదించండి'}</h2>
                        <p>
                            {language === 'en'
                                ? 'Have questions or want to get involved? Reach out to us!'
                                : 'ప్రశ్నలు ఉన్నాయా లేదా పాల్గొనాలనుకుంటున్నారా? మమ్మల్ని సంప్రదించండి!'}
                        </p>
                    ...
                    >
                        <h2>{language === 'en' ? 'Send Us a Message' : 'మాకు సందేశం పంపండి'}</h2>
